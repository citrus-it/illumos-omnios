...
#define	VIRTIO_PCI_CAP_BAROFF		8
#define	VIRTIO_PCI_CAP_BARLEN		12
#define	VIRTIO_PCI_CAP_MULTIPLIER	16	/* NOTIFY CFG ONLY */
...
/*
 * We choose to align things to the most restrictive of the above.
 */
