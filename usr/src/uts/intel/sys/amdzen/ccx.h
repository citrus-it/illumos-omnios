...
DECL_FIELD_RW(TW_CFG, EN_A_BIT_COALESCING, 55, 55);
DECL_FIELD_RW(TW_CFG, COMBINE_CR0_CD, 49, 49);
DECL_FIELD_RW(TW_CFG_U_ZEN5, TLBI_BACK_TO_BACK_CNT_ALWAYS, 46, 46);
DECL_FIELD_RW(TW_CFG, DIS_NESTED_COALESCED_LEAF_CACHE, 24, 24);
DECL_FIELD_RW(TW_CFG, DIS_NESTED_PDE_CACHE, 17, 17);
DECL_FIELD_RW(TW_CFG, DIS_NESTED_PDPE_CACHE, 16, 16);
DECL_FIELD_RW(TW_CFG, DIS_NESTED_PML4E_CACHE, 15, 15);
DECL_FIELD_RW(TW_CFG, DIS_GUEST_PDE_CACHE, 14, 14);
DECL_FIELD_RW(TW_CFG, DIS_GUEST_PDPE_CACHE, 13, 13);
DECL_FIELD_RW(TW_CFG, DIS_GUEST_PML4E_CACHE, 12, 12);
DECL_FIELD_RW(TW_CFG, DIS_HOST_NATIVE_PDE_CACHE, 11, 11);
DECL_FIELD_RW(TW_CFG, DIS_HOST_NATIVE_PDPE_CACHE, 10, 10);
DECL_FIELD_RW(TW_CFG, DIS_HOST_NATIVE_PML4E_CACHE, 9, 9);
DECL_FIELD_RW(TW_CFG, DIS_32K_PAGES, 8, 8);
DECL_FIELD_RW(TW_CFG, DIS_DC_SPEC_WALK, 7, 7);
DECL_FIELD_RW(TW_CFG, DIS_ALL_SPEC_WALK, 5, 5);
...
DECL_FIELD_RW(LS_CFG4, REMAP_FLUSH_ALL_ALWAYS, 7, 7);
