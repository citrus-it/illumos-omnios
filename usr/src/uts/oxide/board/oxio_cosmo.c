 ...
 *     apart from the T6 NIC in manufacturing mode - see note below.
 ...
 * M.2 0 (A)	P2	0-3	0x30-0x33	cr, rx(0,1,2), tx(3)
 * M.2 1 (B)	P3	0-3	0x10-0x13	cr, rx(1,2,3), tx(0)
 ...
 * i2c devices everything is on. Unlike Gimlet, there are no I/O expanders
 * for PERST which is controlled entirely by the FPGA.
 *
 * DEVICE	PORT	TYPE	I2C/BYTE	SLOT
 * NIC		P1	9506	0x22/2		0x10
 * M.2 0 (A)	P2	9506	0x22/0		0x11
 * M.2 1 (B)	P3	9506	0x22/1		0x12
 * U.2 0 (A)	G0	9506	0x20/0		0x00
 * U.2 1 (B)	G0	9506	0x20/1		0x01
 * U.2 2 (C)	G0	9506	0x20/2		0x02
 * U.2 3 (D)	G0	9506	0x20/3		0x03
 * U.2 4 (E)	G2	9506	0x20/4		0x04
 * U.2 5 (F)	G2	9506	0x21/0		0x05
 * U.2 6 (G)	G3	9506	0x21/1		0x06
 * U.2 7 (H)	G3	9506	0x21/2		0x07
 * U.2 8 (I)	G3	9506	0x21/3		0x08
 * U.2 9 (J)	G2	9506	0x21/4		0x09
...
const oxio_engine_t oxio_cosmo[] = { {
	...
	.oe_name = "MCIO",
	.oe_type = OXIO_ENGINE_T_PCIE,
	.oe_hp_type = OXIO_HOTPLUG_T_NONE,
