 ...
 */
struct turin_pcie_core;
struct turin_pcie_port;

typedef struct turin_pcie_core turin_pcie_core_t;
typedef struct turin_pcie_port turin_pcie_port_t;

typedef int (*turin_pcie_core_cb_f)(turin_pcie_core_t *, void *);
typedef int (*turin_pcie_port_cb_f)(turin_pcie_port_t *, void *);
...
#define	PCIE_PORT_LC_PRESET_MASK_CTL(n, p, b)	\
    turin_pcie_port_smn_reg((n), D_PCIE_PORT_LC_PRESET_MASK_CTL, (p), (b))
 ...
 */
/*CSTYLED*/
#define	D_PCIE_CORE_PCIE_RCB_CTL	(const smn_reg_def_t){	\
	.srd_unit = SMN_UNIT_PCIE_CORE,	\
	.srd_reg = 0x1b0	\
}
#define	PCIE_CORE_PCIE_RCB_CTL(n, p)	\
    turin_pcie_core_smn_reg((n), D_PCIE_CORE_PCIE_RCB_CTL, (p))
#define	PCIE_CORE_PCIE_RCB_CTL_SET_SWUS_CA_CTO_EN(r, v)	bitset32(r, 30, 30, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_RC_CA_CTO_EN(r, v)	bitset32(r, 29, 29, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_SWUS_UR_CTO_EN(r, v)	bitset32(r, 28, 28, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_RX_DPC_CPL_MODE(r, v)	\
    bitset32(r, 27, 27, v)
#define	PCIE_CORE_PCIE_RCB_CTL_RX_DPC_CPL_MODE_CTO	0
#define	PCIE_CORE_PCIE_RCB_CTL_RX_DPC_CPL_MODE_URCA	1
#define	PCIE_CORE_PCIE_RCB_CTL_SET_RX_DPC_RPIO_TO_CA_EN(r, v)	\
    bitset32(r, 26, 26, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_IGN_SFI_CAM_DIS(r, v)	\
    bitset32(r, 25, 25, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_LINK_DOWN_CTO_EN(r, v)	\
    bitset32(r, 23, 23, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_RX_ALL_CTO_TO_UR_EN(r, v)	\
    bitset32(r, 22, 22, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_BAD_PREFIX_DIS(r, v)	bitset32(r, 4, 4, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_BAD_FUNC_DIS(r, v)	bitset32(r, 2, 2, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_BAD_ATTR_DIS(r, v)	bitset32(r, 1, 1, v)
#define	PCIE_CORE_PCIE_RCB_CTL_SET_BAD_SIZE_DIS(r, v)	bitset32(r, 0, 0, v)
...
#define	PCIE_CORE_CI_CTL_SET_SLV_SDP_CONNECT_EN		bitset32(r, 17, 17, v)
...
#if 0
/* XXX - The register is not in the Turin PPR but references to it still are */
 ...
 *  PCIECOREx1A[3...B]83FF8 (PCIECORE::SMU_PCIE_FENCED1_REG)
 */
