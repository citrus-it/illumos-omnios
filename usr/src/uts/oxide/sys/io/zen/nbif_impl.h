...
typedef enum {
	 ...
	 */
	ZEN_NBIF_F_AER_EN	= 1 << 3,
	/*
	 * Enable or disble communication of Dx state change.
	 */
	ZEN_NBIF_F_PMSTATUS_EN	= 1 << 4,
	ZEN_NBIF_F_PMSTATUS_DIS	= 1 << 5,
	/*
...
typedef struct zen_nbif_info {
	...
	zen_nbif_func_flag_t	zni_flags;
	bool			zni_enabled;
	uint8_t			zni_dev;
	uint8_t			zni_func;
} zen_nbif_info_t;
