...
// XXX for milan?
#define	NBIF_STRAP_DUMMY_DEVICE_ID	0x
 ...
 * This is modeled as two separate registers as there are two things going on
 * here. This first one is the relatively straightforward per nBIF strap.
 */
/*CSTYLED*/
...
#define	NBIF_PCIEP_STRAP_MISC(i, n, d)	\
    milan_nbif_smn_reg(i, D_NBIF_PCIEP_STRAP_MISC, n, d)
#define	NBIF_PCIP_STRAP_MISC_MULTIFUN_EN(r, v)	bitset32(r, 10, 10, v);

/*
 * Then this is the second part, the port-specific straps where the port is
 * selected as the register index.
 */
/*CSTYLED*/
