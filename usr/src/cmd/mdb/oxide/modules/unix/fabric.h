...
#define	FABRIC_DCMDS	\
	...
	{ "ioms", "?[-n num] [-h hub] [-N nbio] [-i iohc] [-b bus] " \
	    "[-f|-x flags]", "show IOMS", fabric_ioms_dcmd, \
	    fabric_ioms_dcmd_help }, \
	{ "pcie_core", "?[-n num] [-i iohc] [-b bus] [-f|-x flags]", \
	    "show PCIe cores", fabric_pcie_core_dcmd, \
	    fabric_pcie_core_dcmd_help }, \
	{ "pcie_port", "?[-n num] [-c core] [-b bus] [-s slot] [-f|-x flags]", \
	    "show PCIe ports", fabric_pcie_port_dcmd, \
	    fabric_pcie_port_dcmd_help }, \
	{ "nbif", "?[-n num] [-b bus]", "show nBIFs", fabric_nbif_dcmd, \
	    fabric_nbif_dcmd_help }, \
	{ "nbif_func", "?[-n num] [-b bus] [-t type] [-f|-x flags]", \
...
extern void fabric_walk_fini(mdb_walk_state_t *);

#define	FABRIC_WALKER(_name, _descr, _level)	\
	{ _name, _descr, fabric_walk_init, fabric_walk_step, fabric_walk_fini, \
