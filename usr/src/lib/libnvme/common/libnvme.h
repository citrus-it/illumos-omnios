 ...
 * ...").
 *
 * If a controller is passed as NULL for nvme_sctostr(), we will assume that it
 ...
 * differently controller types, this function will always assume a PCI I/O
