 ...
 * credentials of the calling process aren't considered. This is for callers
 * which check authorizations of users other than the process owner, and
 * either have authenticated the user themselves or must not have the
 * authenticated set considered at all.
 */
int
