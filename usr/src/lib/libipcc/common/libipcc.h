 ...
 * RoT request.
 */
typedef struct libipcc_rot libipcc_rot_t;

extern bool libipcc_rot(libipcc_handle_t *, uint8_t *, size_t,
    libipcc_rot_t **);
extern uint8_t *libipcc_rot_buf(libipcc_rot_t *, size_t *);
extern void libipcc_rot_free(libipcc_rot_t *);
