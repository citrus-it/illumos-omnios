...
#
# ASSERTION: svcadm_enable_001
#
# DESCRIPTION:
#	Calling 'svcadm enable <service>' where service is a service instance 
#	that is	already in the enabled state will have no effect on the service.
...
#	- Again Enable it using svcadm enable <service>
#	- Make sure it exits 0, state unchanged from online.
#
# COMMANDS: svcadm(1)
#
...
# Define Variables
readonly assertion=svcadm_enable_001
readonly svccfg_add_script=/var/tmp/svcadm_enable_001.$$.config
