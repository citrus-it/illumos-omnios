...
#
# ASSERTION: svcadm_enable_004
#
# DESCRIPTION:
#	Calling 'svcadm enable FMRI' where FMRI is a service instance that is
#	already in the enabled state will have no effect on the service.
...
#	- Again Enable it using svcadm enable FMRI
...
# Define Variables
readonly assertion=svcadm_enable_004
readonly svccfg_add_script=/var/tmp/svcadm_enable_004.$$.config
