...
#
# ASSERTION: svcadm_maintenance_002
#
# DESCRIPTION:
#	Calling 'svcadm -v mark maintenance FMRI' where FMRI is a service 
#	instance that is in the disabled state should get STATE transit to
#	maintenance state.
# STRATEGY:
...
#	- Also verify it prints the message "Action maint_on set for 
#		$FMRI"
...
# Define Variables
readonly assertion=svcadm_maintenance_002
readonly ME=$(whence -p ${0})
readonly MYLOC=$(dirname ${ME})
readonly test_service="maintenance_002$$"
readonly test_instance="maintenance_002$$"
readonly test_fmri="svc:/$test_service:$test_instance"
readonly svccfg_add_script=/var/tmp/maintenance_002$$.cfg
...
# VERIFY ASSERTION
#
output=`svcadm -v mark maintenance $test_fmri 2>/dev/null`
ret=$?
if [[ "$output" != "Action maint_on set for $test_fmri." || $ret -ne 0 ]]; then
