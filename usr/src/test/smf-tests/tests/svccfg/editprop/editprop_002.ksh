...
#
# ASSERTION: svccfg_editprop_002
#
# DESCRIPTION:
#	Calling the 'editprop' subcommand when no entity has 
#	been selected then a diagnostic message is sent to stderr 
#	and the subcommand exits with an exit status of 1.
#
...
# Assertion ID
readonly assertion=svccfg_editprop_002
...
svccfg editprop > $OUTFILE 2>$ERRFILE
ret=$?
# Verify that the return value is as expected - non-fatal error
[[ $ret -ne 1 ]] &&  {
	echo "--DIAG: [${assertion}]
	svccfg editprop expected to return 1, got $ret"
