...
#
# ASSERTION: svccfg_delpg_006
#
# DESCRIPTION:
#       The 'delpg' subcommand must be called when the current entity
#	is a service or instance.  If the current entity is scope than
...
svccfg delpg foo > $OUTFILE 2>$ERRFILE
ret=$?
