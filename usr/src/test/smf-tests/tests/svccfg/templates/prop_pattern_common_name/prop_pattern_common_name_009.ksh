...
#
# ASSERTION: prop_pattern_common_name_009
#
# DESCRIPTION:
#	Verify the property group common name pattern when the explicitly 
...
readonly registration_file=/tmp/prop_pattern_common_name_009.xml
