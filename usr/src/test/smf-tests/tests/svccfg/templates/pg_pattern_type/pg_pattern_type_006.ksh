...
#
# ASSERTION: pg_pattern_type_006
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when teyp is set but no name.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_type_006.xml
...
verify_prop $test_service $pgn/type astring $PG_TYPE
