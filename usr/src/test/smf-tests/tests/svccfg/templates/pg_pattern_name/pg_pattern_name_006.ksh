...
#
# ASSERTION: pg_pattern_name_006
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes when the name is longer than max length should fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_name_006.xml
