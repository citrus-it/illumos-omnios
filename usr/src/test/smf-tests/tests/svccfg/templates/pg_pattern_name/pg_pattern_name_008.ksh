...
#
# ASSERTION: pg_pattern_name_007
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes with a name only and not type, target or required
#	values.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_name_007.xml
