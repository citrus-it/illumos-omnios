...
#
# ASSERTION: prop_pattern_description_009
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly
#	setting all the attributes when loctext is a string of with no text,
#	should fail.
#
# STRATEGY:
...
readonly registration_template=${MANIFEST_LOCTEXT}
readonly registration_file=/tmp/prop_pattern_description_009.xml
...
LOC_TEXT="This is a description"

manifest_generate $registration_template \
	LOCTEXT="$LOC_TEXT" > $registration_file
