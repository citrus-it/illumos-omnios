...
#
# ASSERTION: pg_pattern_target_011
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when the target is not set, it gets the default
#	this.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_target_011.xml
