...
#
# ASSERTION: pg_pattern_target_007
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when target is set to instance but the template
#	is part of an instance, should fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_target_007.xml
