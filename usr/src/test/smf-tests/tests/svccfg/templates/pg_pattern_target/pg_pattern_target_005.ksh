...
#
# ASSERTION: pg_pattern_target_005
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when set to target, validate the pg is in the
#	instance.
#
# STRATEGY:
...
readonly registration_template=${MANIFEST_SERVICE}
readonly registration_file=/tmp/pg_pattern_target_005.xml
...
echo "--INFO: Validate the property group pattern service target is in the instance"
