...
#
# ASSERTION: pg_pattern_target_010
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when the target is delegate and is part of the
#	restarter, and the template actually delegates to the service.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_target_010.xml
