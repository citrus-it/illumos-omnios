...
#
# ASSERTION: prop_pattern_choices_004
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice range only has the max
#	value set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_004.xml
...
manifest_generate $registration_template \
	...
	CONSTRAINTS="" \
	CHOICEVALUE="" \
	CHOICERANGE="<range max='$CHOICE_RANGEMAX' />" \
