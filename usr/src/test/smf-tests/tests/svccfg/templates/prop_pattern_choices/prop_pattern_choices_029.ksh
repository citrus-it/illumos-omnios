...
#
# ASSERTION: prop_pattern_choices_029
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with constraints, values and choice range, and
#	include values set to constraints.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_029.xml
