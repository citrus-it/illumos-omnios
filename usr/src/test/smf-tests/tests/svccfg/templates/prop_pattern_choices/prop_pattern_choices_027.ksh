...
#
# ASSERTION: prop_pattern_choices_027
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with multiline values, choice values, constraints
#	and include values
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_027.xml
...
vname1=`$NAME_GEN 8`
vname2=`$NAME_GEN 8`
echo "--INFO: Using value names $vname1 and $vname2"
VALUES="<values>\\
		<value name='$vname1'>\\
			<common_name>\\
				<loctext xml:lang='C'>\\
...
INCLUDE_VALUES="<include_values type='constraints' />"
...
verify_prop $test_service $pgn/choices_include_values astring constraints
