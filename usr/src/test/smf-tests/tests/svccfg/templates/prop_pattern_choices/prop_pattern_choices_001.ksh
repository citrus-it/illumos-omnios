...
#
# ASSERTION: prop_pattern_choices_001
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice is a simple word value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_001.xml
