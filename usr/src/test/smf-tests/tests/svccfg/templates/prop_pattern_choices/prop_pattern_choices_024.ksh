...
#
# ASSERTION: prop_pattern_choices_024
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with multi line include values and constraints.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_024.xml
