...
#
# ASSERTION: prop_pattern_choices_025
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with multiline include values set to constraints
#	and values with no constraints or values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_025.xml
...
MLINE_INCVALUES="\$INCLUDE_VALUES"
...
manifest_generate $registration_template \
	...
	CHOICEVALUE="" \
	CHOICERANGE="" \
	INCVALUES="$MLINE_INCVALUES" > $registration_file
