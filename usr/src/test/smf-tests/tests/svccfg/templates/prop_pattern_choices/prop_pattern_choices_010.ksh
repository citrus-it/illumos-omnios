...
#
# ASSERTION: prop_pattern_choices_010
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice range min and max are single
#	characters.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_010.xml
