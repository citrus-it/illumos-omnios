...
#
# ASSERTION: prop_pattern_choices_026
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with include values set to garbage.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_026.xml
...
AV_TYPES="type='garbarge' type='' type=';' type='\&foob'"

for AV_TYPE in $AV_TYPES
do
	INCLUDE_VALUES="<include_values type='garbage' />"
