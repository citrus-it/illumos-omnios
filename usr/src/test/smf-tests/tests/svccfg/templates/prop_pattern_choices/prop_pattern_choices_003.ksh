...
#
# ASSERTION: prop_pattern_choices_003
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice range only has a min value
#	set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_003.xml
...
manifest_generate $registration_template \
	...
	CONSTRAINTS="" \
	CHOICEVALUE="" \
	CHOICERANGE="<range min='$CHOICE_RANGEMIN' />" \
