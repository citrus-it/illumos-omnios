...
#
# ASSERTION: prop_pattern_choices_016
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with multiline constraints and include values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_016.xml
