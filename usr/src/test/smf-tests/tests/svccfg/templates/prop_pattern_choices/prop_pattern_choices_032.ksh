...
#
# ASSERTION: prop_pattern_choices_032
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes with values and constraints, and include values
#	set to values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_032.xml
