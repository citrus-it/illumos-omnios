...
#
# ASSERTION: prop_pattern_choices_031
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes with values, constraints and include values set
#	to constraints.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_031.xml
