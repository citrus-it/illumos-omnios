...
#
# ASSERTION: prop_pattern_choices_007
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice range min is greater than
#	then choice range max value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_007.xml
