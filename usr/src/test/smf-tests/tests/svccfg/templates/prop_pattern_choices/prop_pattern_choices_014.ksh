...
#
# ASSERTION: prop_pattern_choices_014
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with multiline values, constraints and include
#	values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_014.xml
