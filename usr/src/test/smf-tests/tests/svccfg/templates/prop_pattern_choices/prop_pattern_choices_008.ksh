...
#
# ASSERTION: prop_pattern_choices_008
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice range max approaches the max
#	value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_008.xml
