...
#
# ASSERTION: prop_pattern_choices_030
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with choices range, values and constraints, with
#	include values set to values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_030.xml
