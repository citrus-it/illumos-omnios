...
#
# ASSERTION: prop_pattern_choices_009
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice range max is at the max value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_009.xml
