...
#
# ASSERTION: prop_pattern_choices_018
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with multi line values, constraints and include
#	values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_018.xml
