...
#
# ASSERTION: prop_pattern_choices_023
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, with multiline include values and values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_023.xml
