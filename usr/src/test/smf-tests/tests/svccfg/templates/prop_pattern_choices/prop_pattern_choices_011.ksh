...
#
# ASSERTION: prop_pattern_choices_011
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when both a choice range and value are specified.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_011.xml
