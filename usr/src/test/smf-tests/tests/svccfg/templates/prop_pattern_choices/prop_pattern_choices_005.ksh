...
#
# ASSERTION: prop_pattern_choices_005
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the choice range min value is negative.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_choices_005.xml
