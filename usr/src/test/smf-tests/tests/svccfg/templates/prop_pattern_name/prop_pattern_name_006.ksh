...
#
# ASSERTION: prop_pattern_name_006
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the property name is grearter than the
#	maximum limit.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_name_006.xml
