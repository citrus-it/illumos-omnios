...
#
# ASSERTION: prop_pattern_name_008
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the name is set and the required flag
#	is not.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_name_008.xml
...
manifest_generate $registration_template \
	...
	PROPREQUIRED="" > $registration_file
