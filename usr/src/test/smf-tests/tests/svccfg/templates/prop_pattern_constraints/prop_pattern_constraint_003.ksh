...
#
# ASSERTION: prop_pattern_constraint_003
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when constratin range has no max set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_003.xml
...
manifest_generate $registration_template \
	...
	PROPVALUE="" \
	PROPRANGE="<range min='$PROP_RANGEMIN' />" > $registration_file
