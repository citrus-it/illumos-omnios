...
#
# ASSERTION: prop_pattern_constraint_006
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the cosntratin range min value is 0.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_006.xml
