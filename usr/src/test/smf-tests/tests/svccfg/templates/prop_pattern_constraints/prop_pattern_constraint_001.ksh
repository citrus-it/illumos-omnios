...
#
# ASSERTION: prop_pattern_constraint_001
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when constraint value is a basic string.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_001.xml
