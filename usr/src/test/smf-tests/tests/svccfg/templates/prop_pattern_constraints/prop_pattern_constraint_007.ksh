...
#
# ASSERTION: prop_pattern_constraint_007
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes when the constraint range min is greater
#	than the max.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_007.xml
