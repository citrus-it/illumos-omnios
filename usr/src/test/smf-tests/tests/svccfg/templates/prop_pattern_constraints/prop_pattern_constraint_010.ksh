...
#
# ASSERTION: prop_pattern_constraint_010
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the constraint range min and max values
...
readonly registration_file=/tmp/prop_pattern_constraint_010.xml
