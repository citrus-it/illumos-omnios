...
#
# ASSERTION: prop_pattern_constraint_002
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes when constraint range is a basic range.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_002.xml
