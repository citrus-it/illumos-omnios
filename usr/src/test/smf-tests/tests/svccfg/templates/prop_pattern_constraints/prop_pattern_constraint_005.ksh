...
#
# ASSERTION: prop_pattern_constraint_005
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the constraint range min is a negative
#	value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_005.xml
