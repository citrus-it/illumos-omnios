...
#
# ASSERTION: prop_pattern_constraint_004
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when constraint range has no min set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_004.xml
...
manifest_generate $registration_template \
	...
	PROPVALUE="" \
	PROPRANGE="<range max='$PROP_RANGEMAX' />" > $registration_file
