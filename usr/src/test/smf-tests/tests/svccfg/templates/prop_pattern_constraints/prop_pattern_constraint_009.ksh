...
#
# ASSERTION: prop_pattern_constraint_009
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes, when the constraint range max is the maximum
#	value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_constraint_009.xml
