...
#
# ASSERTION: prop_pattern_cardinality_005
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, when min is a negative value, should fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_005.xml
