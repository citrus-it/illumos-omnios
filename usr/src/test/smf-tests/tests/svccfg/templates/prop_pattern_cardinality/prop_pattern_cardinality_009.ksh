...
#
# ASSERTION: prop_pattern_cardinality_009
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, when min is the max value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_009.xml
