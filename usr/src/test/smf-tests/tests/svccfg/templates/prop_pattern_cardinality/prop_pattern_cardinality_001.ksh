...
#
# ASSERTION: prop_pattern_cardinality_001
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, when min and max a simply set to small values.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_001.xml
