...
#
# ASSERTION: prop_pattern_cardinality_011
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, the max is at the max value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_011.xml
...
verify_prop $test_service $pgn/cardinality_min count $DEF_CARDMIN
verify_prop $test_service $pgn/cardinality_max count $PROP_CARDMAX
