...
#
# ASSERTION: prop_pattern_cardinality_012
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, min is set to a string number (e.g one), should
#	fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_012.xml
