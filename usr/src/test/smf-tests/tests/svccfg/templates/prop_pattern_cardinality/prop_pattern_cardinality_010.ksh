...
#
# ASSERTION: prop_pattern_cardinality_010
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, when max is the max value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_010.xml
