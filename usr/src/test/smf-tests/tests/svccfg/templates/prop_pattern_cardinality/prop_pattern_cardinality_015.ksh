...
#
# ASSERTION: prop_pattern_cardinality_015
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, when max is set to a single character.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_015.xml
