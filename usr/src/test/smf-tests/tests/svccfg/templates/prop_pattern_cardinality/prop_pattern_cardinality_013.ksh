...
#
# ASSERTION: prop_pattern_cardinality_013
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, max is set to a string number (three), should
#	fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_013.xml
