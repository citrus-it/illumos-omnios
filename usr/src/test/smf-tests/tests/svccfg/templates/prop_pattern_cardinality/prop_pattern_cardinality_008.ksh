...
#
# ASSERTION: prop_pattern_cardinality_008
#
# DESCRIPTION:
#	Verify the property cardinality pattern when the explicitly setting
#	all the attributes, when min approaches the max value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_cardinality_008.xml
...
verify_prop $test_service $pgn/cardinality_min count $PROP_CARDMIN
verify_prop $test_service $pgn/cardinality_max count $DEF_CARDMAX
