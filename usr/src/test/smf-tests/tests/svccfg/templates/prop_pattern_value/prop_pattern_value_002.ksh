...
#
# ASSERTION: prop_pattern_value_002
#
# DESCRIPTION:
#	Verify the property group common name pattern when the explicitly setting
#	all the attributes with a value name with just the description set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_002.xml
