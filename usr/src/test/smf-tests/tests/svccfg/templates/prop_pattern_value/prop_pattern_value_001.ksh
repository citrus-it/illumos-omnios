...
#
# ASSERTION: prop_pattern_value_001
#
# DESCRIPTION:
#	Verify the property group common name pattern when the explicitly setting
#	all the attributes a value name with just common name set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_001.xml
