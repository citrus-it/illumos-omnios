...
#
# ASSERTION: prop_pattern_value_003
#
# DESCRIPTION:
#	Verify the property group common name pattern when the explicitly setting
#	all the attributes a value name with both description and common name set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_003.xml
...
VALUE_DESC="\$DESC_TEXT"

manifest_generate $registration_template \
	COMMONNAME="$COMMON_NAME" \
	DESCRIPTION="$VALUE_DESC" \ > $registration_file
...
verify_prop $test_service $pgn/value_${encoded_vn}_description_C ustring "Test Value"
