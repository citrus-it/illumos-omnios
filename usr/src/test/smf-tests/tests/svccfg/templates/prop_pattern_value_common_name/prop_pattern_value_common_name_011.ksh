...
#
# ASSERTION: prop_pattern_value_common_name_011
#
# DESCRIPTION:
#	Verify the property group common name pattern when the explicitly setting
#	all the attributes when input is not proper UTF-8.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_common_name_011.xml
...
manifest_generate $registration_template \
	CNAME_LANG_1="'C'" \
	COMMON_NAME_1="Common templates name description" \
	CNAME_LANG_2="'ES'" \
	COMMON_NAME_2="Descripción conocida de las plantillas comunes" > $registration_file
