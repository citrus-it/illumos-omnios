...
#
# ASSERTION: prop_pattern_value_common_name_001
#
# DESCRIPTION:
...
readonly registration_file=/tmp/prop_pattern_value_common_name_001.xml
...
manifest_generate $registration_template \
	CNAME_LANG_1="'C'" \
	COMMON_NAME_1="Common templates name" \
	CNAME_LANG_2="'ES'" \
	COMMON_NAME_2="Nombre com'un de la plantilla" > $registration_file
...
echo "--INFO: Validate the property group pattern value common name"
pgn=${PROP_PREFIX_NT}${PG_NAME}_${PROP_NAME}
encoded_vn=`$BASE32_CODE -e $VALUE_NAME`
verify_prop $test_service $pgn/value_${encoded_vn}_common_name_C ustring "Common templates name"
verify_prop $test_service $pgn/value_${encoded_vn}_common_name_ES ustring "Nombre com'un de la plantilla"
