...
#
# ASSERTION: prop_pattern_value_common_name_007
#
# DESCRIPTION:
...
readonly registration_file=/tmp/prop_pattern_value_common_name_007.xml
...
do
	...
	verify_prop QUIET $test_service \
	    $pgn/value_${encoded_vn}_common_name_$CNAME_LANG ustring \
	    $COMMON_NAME
