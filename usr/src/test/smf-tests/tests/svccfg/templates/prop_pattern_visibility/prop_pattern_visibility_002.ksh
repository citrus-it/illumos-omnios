...
#
# ASSERTION: prop_pattern_visibility_002
#
# DESCRIPTION:
#	Verify the property visibility pattern when the explicitly setting
#	all the attributes with visibility set to readonly.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_visibility_002.xml
