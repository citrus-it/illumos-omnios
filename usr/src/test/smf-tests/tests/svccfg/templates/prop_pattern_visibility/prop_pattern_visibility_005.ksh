...
#
# ASSERTION: prop_pattern_visibility_005
#
# DESCRIPTION:
#	Verify the property visibility pattern when the explicitly setting
#	all the attributes with visibility not set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_visibility_005.xml
...
manifest_generate $registration_template \
	...
	PROPVISIBILITY="<visibility />" > $registration_file
