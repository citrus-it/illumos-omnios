...
#
# ASSERTION: prop_pattern_visibility_004
#
# DESCRIPTION:
#	Verify the property visibility pattern when the explicitly setting
#	all the attributes with visilbity set to garbage.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_visibility_004.xml
