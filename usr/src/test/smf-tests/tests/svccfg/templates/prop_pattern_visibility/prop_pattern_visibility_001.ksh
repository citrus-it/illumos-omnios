...
#
# ASSERTION: prop_pattern_visibility_001
#
# DESCRIPTION:
#	Verify the property visibility pattern when the explicitly setting
#	all the attributes with visibility set to hidden.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_visibility_001.xml
