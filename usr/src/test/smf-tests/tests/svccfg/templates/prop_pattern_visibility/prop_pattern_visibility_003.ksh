...
#
# ASSERTION: prop_pattern_visibility_003
#
# DESCRIPTION:
#	Verify the property visibility pattern when the explicitly setting
#	all the attributes with visibility set to read write.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_visibility_003.xml
...
PG_NAME="foo"
PROP_NAME="bar"
PROP_VISIBILITY="readwrite"

manifest_generate $registration_template \
	PROPNAME="name='$PROP_NAME'" \
	PROPTYPE="type='astring'" \
	PROPREQUIRED="required='false'" \
	PROPVISIBILITY="<visibility value='$PROP_VISIBILITY' />" > $registration_file
...
verify_prop $test_service $pgn/visibility astring $PROP_VISIBILITY
