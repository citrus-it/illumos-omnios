...
#
# ASSERTION: prop_pattern_separator_009
#
# DESCRIPTION:
#	Verify the property separator pattern when the explicitly setting
#	all the attributes when set to special character set \&amp.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_separator_009.xml
