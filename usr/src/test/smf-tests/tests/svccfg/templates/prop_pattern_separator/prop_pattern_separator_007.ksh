...
#
# ASSERTION: prop_pattern_separator_007
#
# DESCRIPTION:
#	Verify the property separator pattern when the explicitly setting
#	all the attributes when set to a special character set e.g \&lt.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_separator_007.xml
