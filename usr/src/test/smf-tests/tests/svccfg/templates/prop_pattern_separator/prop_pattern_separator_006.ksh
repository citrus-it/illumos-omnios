...
#
# ASSERTION: prop_pattern_separator_006
#
# DESCRIPTION:
#	Verify the property separator pattern when the explicitly setting
#	all the attributes when set to a string of characters.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_separator_006.xml
...
verify_multi $test_service $pgn/internal_separators x y z
