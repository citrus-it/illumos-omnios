...
#
# ASSERTION: prop_pattern_value_description_005
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly setting
#	all the attributes when containing special characters.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_description_005.xml
