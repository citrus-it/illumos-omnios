...
#
# ASSERTION: prop_pattern_value_description_010
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly setting
#	all the attributes when the text spans multiple lines.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_description_010.xml
...
verify_multi $test_service $pgn/value_${encoded_vn}_description_C This is line1 This is line2
