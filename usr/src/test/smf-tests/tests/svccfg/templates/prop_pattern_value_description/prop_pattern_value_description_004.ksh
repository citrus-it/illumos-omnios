...
#
# ASSERTION: prop_pattern_value_description_004
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly setting
#	all the attributes when starting with a special character say '&'.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_description_004.xml
