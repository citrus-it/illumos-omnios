...
#
# ASSERTION: prop_pattern_value_description_007
#
# DESCRIPTION:
...
readonly registration_file=/tmp/prop_pattern_value_description_007.xml
...
do
	...
	verify_prop QUIET $test_service \
	    $pgn/value_${encoded_vn}_description_$DESC_LANG ustring \
	    $DESCRIPTION
