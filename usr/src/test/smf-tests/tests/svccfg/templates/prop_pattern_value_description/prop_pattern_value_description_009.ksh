...
#
# ASSERTION: prop_pattern_value_description_009
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly setting
#	all the attributes when loctext is a string of with no text, should fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_description_009.xml
