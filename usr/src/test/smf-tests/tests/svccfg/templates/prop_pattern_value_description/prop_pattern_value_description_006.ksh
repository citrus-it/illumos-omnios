...
#
# ASSERTION: prop_pattern_value_description_006
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly setting
#	all the attributes when the locale is set to garbage.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_description_006.xml
...
VALUE_NAME="foobar"
DESC_LANG="garbage"
DESCRIPTION="Common template name"
...
verify_prop $test_service $pgn/value_${encoded_vn}_description_$DESC_LANG ustring $DESCRIPTION
