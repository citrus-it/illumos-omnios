...
#
# ASSERTION: prop_pattern_value_description_003
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly setting
#	all the attributes when starting with a number.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_description_003.xml
...
PROP_NAME="bar"
VALUE_NAME="foobar"
DESCRIPTION="123 description line"
...
verify_prop $test_service $pgn/value_${encoded_vn}_description_C ustring $DESCRIPTION
