...
#
# ASSERTION: prop_pattern_value_description_008
#
# DESCRIPTION:
#	Verify the property group description pattern when the explicitly setting
#	all the attributes when there is no text, should fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_description_008.xml
