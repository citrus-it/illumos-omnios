...
#
# ASSERTION: pg_pattern_required_005
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when required is set to true, but no type is set,
#	should fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_required_005.xml
