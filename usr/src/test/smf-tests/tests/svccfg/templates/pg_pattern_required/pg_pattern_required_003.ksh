...
#
# ASSERTION: pg_pattern_required_003
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes gets the default false setting when not set.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_required_003.xml
