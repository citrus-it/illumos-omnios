...
#
# ASSERTION: pg_pattern_required_007
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, required is set to true, but name and type are
#	not set, should fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_required_007.xml
