...
#
# ASSERTION: pg_pattern_required_008
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when required is false, and no name is set.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_required_008.xml
