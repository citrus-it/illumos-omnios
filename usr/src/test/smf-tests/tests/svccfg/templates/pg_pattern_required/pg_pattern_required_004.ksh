...
#
# ASSERTION: pg_pattern_required_004
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, fails when required is not set to falls or true.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_required_004.xml
