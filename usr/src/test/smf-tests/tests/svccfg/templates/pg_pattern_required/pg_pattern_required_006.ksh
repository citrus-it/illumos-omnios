...
#
# ASSERTION: pg_pattern_required_006
#
# DESCRIPTION:
#	Verify the property group name pattern when the explicitly setting
#	all the attributes, when required is true, but name is not set, should
#	fail.
#
# STRATEGY:
...
readonly registration_file=/tmp/pg_pattern_required_006.xml
