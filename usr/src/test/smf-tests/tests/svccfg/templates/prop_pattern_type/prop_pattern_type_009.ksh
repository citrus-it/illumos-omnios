...
#
# ASSERTION: prop_pattern_type_007
#
# DESCRIPTION:
#	Verify the property type pattern when the explicitly setting
#	all the attributes when the property type is not set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_type_007.xml
...
manifest_generate $registration_template \
	...
	PROPTYPE="" \
	PROPREQUIRED="required='false'" > $registration_file
...
echo "--INFO: Validate the property pattern type when setting attributes"
pgn=${PROP_PREFIX}${PG_NAME}_${PROP_NAME}
verify_prop $test_service $pgn/type astring $PROP_TYPE
