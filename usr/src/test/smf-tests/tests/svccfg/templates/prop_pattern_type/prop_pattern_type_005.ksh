...
#
# ASSERTION: prop_pattern_type_005
#
# DESCRIPTION:
#	Verify the property type pattern when the explicitly setting
#	all the attributes when type is set to ustring.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_type_005.xml
