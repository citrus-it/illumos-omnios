...
#
# ASSERTION: prop_pattern_value_name_001
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the value name is a basic string.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_001.xml
