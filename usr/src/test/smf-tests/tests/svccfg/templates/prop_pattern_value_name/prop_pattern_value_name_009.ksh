...
#
# ASSERTION: prop_pattern_value_name_009
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the value starts with punctuation.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_009.xml
