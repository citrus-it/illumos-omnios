...
#
# ASSERTION: prop_pattern_value_name_015
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the valuename doesn't exist.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_015.xml
