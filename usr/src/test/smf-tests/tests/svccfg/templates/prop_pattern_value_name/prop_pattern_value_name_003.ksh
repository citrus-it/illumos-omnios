...
#
# ASSERTION: prop_pattern_value_name_003
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the value name is a single character.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_003.xml
