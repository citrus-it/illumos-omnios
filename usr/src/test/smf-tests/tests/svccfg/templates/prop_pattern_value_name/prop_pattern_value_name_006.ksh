...
#
# ASSERTION: prop_pattern_value_name_006
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the value name is greater than the max.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_006.xml
