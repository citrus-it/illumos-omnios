...
#
# ASSERTION: prop_pattern_value_name_008
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the value name starts with a special character.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_008.xml
