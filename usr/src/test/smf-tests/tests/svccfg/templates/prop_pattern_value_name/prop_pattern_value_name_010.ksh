...
#
# ASSERTION: prop_pattern_value_name_010
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the value starts with a percent symbol.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_010.xml
