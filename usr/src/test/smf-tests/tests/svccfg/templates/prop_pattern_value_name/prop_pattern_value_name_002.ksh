...
#
# ASSERTION: prop_pattern_value_name_002
#
# DESCRIPTION:
#	Verify the property name pattern when the explicitly setting
#	all the attributes the value name starts with a capitol letter.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_value_name_002.xml
