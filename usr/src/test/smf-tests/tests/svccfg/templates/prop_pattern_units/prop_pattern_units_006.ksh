...
#
# ASSERTION: prop_pattern_units_006
#
# DESCRIPTION:
#	Verify the property group units pattern when the explicitly setting
#	all the attributes when the language is set to garbage, and units
#	are set to a string.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_units_006.xml
...
verify_prop $test_service $pgn/units_$UNITS_LANG ustring $UNITS
