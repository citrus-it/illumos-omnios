...
#
# ASSERTION: prop_pattern_units_011
#
# DESCRIPTION:
#	Verify the property group units pattern when the explicitly setting
#	all the attributes with a non UTF-8 character.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_units_011.xml
...
manifest_generate $registration_template \
	UNITS_LANG_1="'C'" \
	UNITS_1="units description" \
	UNITS_LANG_2="'ES'" \
	UNITS_2="descripción de las unidades" > $registration_file
