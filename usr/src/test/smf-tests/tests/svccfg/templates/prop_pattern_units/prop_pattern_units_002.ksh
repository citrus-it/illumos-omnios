...
#
# ASSERTION: prop_pattern_units_002
#
# DESCRIPTION:
#	Verify the property group units pattern when the explicitly setting
#	all the attributes when units contain punctuation.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_units_002.xml
...
verify_prop $test_service $pgn/units_C ustring "$UNITS"
