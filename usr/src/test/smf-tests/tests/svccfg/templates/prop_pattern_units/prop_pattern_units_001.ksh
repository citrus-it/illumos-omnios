...
#
# ASSERTION: prop_pattern_units_001
#
# DESCRIPTION:
#	Verify the property group units pattern when the explicitly setting
#	all the attributes when multiple units are set.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_units_001.xml
...
manifest_generate $registration_template \
	...
	UNITS_1="miles" \
	UNITS_LANG_2="'ES'" \
	UNITS_2="milles" > $registration_file
...
verify_prop $test_service $pgn/units_C ustring "miles"
verify_prop $test_service $pgn/units_ES ustring "milles"
