...
#
# ASSERTION: prop_pattern_units_010
#
# DESCRIPTION:
#	Verify the property group units pattern when the explicitly setting
#	all the attributes when units are set to a multi line value.
#
# STRATEGY:
...
readonly registration_file=/tmp/prop_pattern_units_010.xml
...
verify_multi $test_service $pgn/units_C mile line
