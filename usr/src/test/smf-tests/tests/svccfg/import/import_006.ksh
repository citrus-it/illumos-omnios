...
#
# ASSERTION: svccfg_import_006
#
# DESCRIPTION:
#	Calling the 'import' subcommand where the file is a invalid
#	service manifest will result in a diagnostic message
#	displayed on stderr.  The exit status will be 1.
# 
# STRATEGY:
#	This is a simple test passing to import a manifest file with an
#	error (i.e. an invalid service manifest).  For comprehensive
#	testing of import's handling of invalid service manifests run
#	the DTD tests.
#
...
assertion=svccfg_import_006
readonly registration_file=$MYLOC/import_006.xml
