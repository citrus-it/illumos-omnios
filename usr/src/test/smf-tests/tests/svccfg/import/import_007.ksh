...
#
# ASSERTION: svccfg_import_007
#
# DESCRIPTION:
#	Calling the 'import' subcommand where the file is a 
#	service archive will result in a diagnostic message
...
echo "--INFO: Now attempt to import the generated svccfg archive.
	Expect failure."
...
[[ $ret -ne 1 ]] && {
	echo "--DIAG: [$assertion]
	'svccfg import' did not fail as expected when supplied an archive file
