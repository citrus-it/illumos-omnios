...
#
# STRATEGY:
#	This is a simple test - import a manifest file with a disabled
#	service.  To verify make sure that the service is in the repository
#	and the test service is not running.
#
...
readonly registration_template=$MYLOC/import_002.xml
readonly registration_file=/tmp/import_002.xml
