...
#
# ASSERTION: svccfg_inventory_006
#
# DESCRIPTION:
#	Calling the 'inventory file' subcommand, with multiple 
#	service bundles will return with a diagnostic message 
...
readonly xml_file=$MYLOC/inventory_001.xml

svccfg inventory $xml_file $xml_file > $OUTFILE 2>$ERRFILE
ret=$?
[[ $ret -ne 1 ]] &&  {
	echo "--DIAG: [${assertion}]
