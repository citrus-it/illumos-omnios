...
#
# ASSERTION: svccfg_quit_002
#
# DESCRIPTION:
#	The subcommand "quit" expects no arguments.  If an argument
#	is passed an exit status of 1 is returned and a diagnostic
#	message is sent to stderr.
#
# STRATEGY:
#	Write a simple svccfg script which calls quit and then does
...
svccfg  quit extra_option> $OUTFILE 2>$ERRFILE
ret=$?
