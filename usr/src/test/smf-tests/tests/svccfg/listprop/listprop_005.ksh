...
#
# ASSERTION: svccfg_listprop_005
#
# DESCRIPTION:
#	If no entity is selected then the 'listprop' subcommand will
...
svccfg listprop > $OUTFILE 2>$ERRFILE
ret=$?

# Verify that the return value is as expected - non-fatal error
[[ $ret -ne 1 ]] &&  {
	echo "--DIAG: [${assertion}]
	svccfg listprop expected to return 1, got $ret"
