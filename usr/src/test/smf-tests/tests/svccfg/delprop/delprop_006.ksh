...
#
# ASSERTION: svccfg_delprop_006
#
# DESCRIPTION:
#	If no entity is selected then the 'delprop' subcommand will
#	return a diagnostic message and a return value of 1.
#
...
svccfg delprop $TEST_PROPERTY > $OUTFILE 2>$ERRFILE
ret=$?

# Verify that the return value is as expected - non-fatal error
[[ $ret -ne 1 ]] &&  {
	echo "--DIAG: [${assertion}]
	svccfg delprop expected to return 1, got $ret"
