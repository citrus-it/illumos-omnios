...
#
# ASSERTION: svccfg_delprop_002
#
# DESCRIPTION:
#  	The 'delprop pg' subcommand deletes the property group 
#	'pg' of the currently selected entity.
#
#
...
# Assertion ID
readonly assertion=svccfg_delprop_002
...
[[ $ret -ne 1 ]] &&  {
	echo "--DIAG: [${assertion}]
	svcprop returned $ret, not 1 as expected"
...
if ! egrep -s "$NOT_FOUND_PROPGRP_ERRMSG" $ERRFILE
then
	echo "--DIAG: [${assertion}]
	Expected error message \"$NOT_FOUND_PROPGRP_ERRMSG\"
	but got \"$(cat $ERRFILE)\""
