...
#
# ASSERTION: svccfg_listpg_002
#
# DESCRIPTION:
#	The 'listpg' subcommand lists all the property groups
#	of the currently selected entity. The types and flags are also
#	displayed.
#
# STRATEGY:
#	Use the file pg_data which contains property group information
#	that can be used both to add property group and also to compare
#	the output of the listpg command.
#
