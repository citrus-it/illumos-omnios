...
#
# ASSERTION: svccfg_listpg_003
#
# DESCRIPTION:
#	If no entity is selected then the 'listpg' subcommand will
#	result in a diagnostic message sent to stderr and the
#	exit status of 1 returned.
#
...
svccfg listpg > $OUTFILE 2>$ERRFILE
ret=$?

# Verify that the return value is as expected - non-fatal error
[[ $ret -ne 1 ]] &&  {
	echo "--DIAG: [${assertion}]
	svccfg listpg expected to return 1, got $ret"
