...
#
tested_auths="solaris.smf.modify.framework"
[[ $result == $STF_PASS ]] && \
...
#
# To the method and userdefined-type pgs, add a value_authorization
# property which specifies a set of authorizations.
#
dep_auths='"solaris.smf.modify.framework" "solaris.smf.modify.application"'
app_auths='"solaris.smf.modify.method" "solaris.smf.modify.framework"'
...
# Add a modify_authorization property also, which specifies a different
# set of authorizations from the value_authorization property
#
