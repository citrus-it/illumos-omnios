...
#
# ASSERTION: svccfg_security_profile_002
#
# DESCRIPTION:
#	A user belonging only to the 'Service Management' profile can
#	create, delete or modify any services, service instances, pgs
#	and properties of any type, including user-defined types.
#
...
readonly prog=${0##*/}
# Assertion ID
readonly assertion=svccfg_security_profiles_002
