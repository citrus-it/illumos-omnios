...
#
# ASSERTION: context_023
# DESCRIPTION:
#  :default can be used as a token to indicate the use of the resource
#  pool specified in the project(4) entry for the project specified in
...
readonly registration_template=$DATA/service_023.xml
