...
#
# ASSERTION: context_003
# DESCRIPTION:
#  svc.startd will start a method using the user credentials specified
#  by the user attribute in text form of the method_credential element
#
...
readonly registration_template=$DATA/service_003.xml
...
print -- "--INFO: Checking start methods username is $ctx_user"
...
if [ "$line" != "$ctx_user" ]; then
	print -- "--DIAG: $assertion: username of execution $line "
        print -- "  wasn't $ctx_user"
	exit $STF_FAIL
fi
