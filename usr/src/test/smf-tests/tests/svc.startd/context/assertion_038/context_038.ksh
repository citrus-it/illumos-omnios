...
print -- "--INFO: acquiring the ids of at most 5 groups" 
...
readonly registration_template=$DATA/service_038.xml
...
if [ $? -ne 0 ]; then
	print -- "--DIAG: Could not find suppgroupids line from "
