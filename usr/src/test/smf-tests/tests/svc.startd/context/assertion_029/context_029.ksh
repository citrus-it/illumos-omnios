...
#
# ASSERTION: context_029
# DESCRIPTION:
#  Atempting to start a service with an invalid project
...
manifest_generate $registration_template \
	...
	LOGFILE=$service_log \
	PROJECT=${ctx_project}_with_monkeys \
...
if [ $? -ne 0 ]; then
	print -- "--DIAG: $assertion: Service $test_FMRI did not enter"
	print -- "  maintenance state."
	print -- "  It was in '$(svcs -H -o STATE $test_FMRI)' state."
	exit $STF_FAIL
fi
