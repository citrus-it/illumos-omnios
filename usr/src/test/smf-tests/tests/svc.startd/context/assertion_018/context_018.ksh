...
#
# ASSERTION: context_018
# DESCRIPTION:
#  svc.startd will start a method from the directory specified in
#  the working_directory attribute of the method_context.
#
...
readonly registration_template=$DATA/service_018.xml
