...
# DESCRIPTION:
#  If no working_directory attribute is given, the svc.startd will
#  execute the method in :home directory of the user that the method
#  will be executed as.
#
...
readonly registration_template=$DATA/service_024.xml
...
print -- "--INFO: Checking start method's working directory"
...
if [ "${line}" != "$TESTDIR" ]; then
	print -- "--DIAG: Did not have working directory $TESTDIR."
