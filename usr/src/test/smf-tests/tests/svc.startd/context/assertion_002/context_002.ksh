...
#
# ASSERTION: context_002
# DESCRIPTION:
#  svc.startd will start a method using the user credentials specified
#  by the user attribute in numeric form of the method_credential element
#
...
readonly registration_template=$DATA/service_002.xml
...
print -- "--INFO: Checking start methods userid is $CTX_UID"
...
if [ "$line" != "$CTX_UID" ]; then
	print -- "--DIAG: $assertion: userid of execution $line wasn't $CTX_UID"
	exit $STF_FAIL
fi
