...
#
# ASSERTION: context_043
# DESCRIPTION:
#  A methods method_context user entry specifies an unknown userid.
#  and specifies a working directory of ':home'. The method should not
#  be invoked and the service shall transition to maintenance
#
...
test_id=0
while [ -n "`getent passwd $test_id`" ]; do
	test_id=$((test_id + 1))
done
