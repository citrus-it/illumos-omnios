...
#
# ASSERTION: context_005
# DESCRIPTION:
#  svc.startd will start a method using the group credentials specified
#  by the group attribute in text form of the method_credential element
#
...
print -- "--INFO: Checking start methods groupname is $ctx_group"
...
if [ "$line" != "$ctx_group" ]; then
	print -- "--DIAG: $assertion: groupname of execution $line "
        print -- "  wasn't $ctx_group"
	exit $STF_FAIL
fi
