...
#
# ASSERTION: methods_042
# DESCRIPTION:
#  A service possessing a disable method will have that method executed
#  upon the issuing of 'svcadm disable'
...
registration_template=$DATA/service_042.xml
...
print -- "--INFO: disabling service $test_FMRI"
svcadm disable $test_FMRI

print -- "--INFO: Waiting for invocation of disable method"
service_wait_method $test_FMRI disable
if [ $? -ne 0 ]; then
	print -- "--DIAG: $assertion: $test_FMRI didn't execute disable method"
	exit $STF_FAIL
fi
