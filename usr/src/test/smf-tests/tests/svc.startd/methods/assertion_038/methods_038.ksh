...
#
# ASSERTION: methods_038
# DESCRIPTION:
#  A service possessing an enable method will have that method executed
#  upon the issuing of 'svcadm enable'
...
registration_template=$DATA/service_038.xml
