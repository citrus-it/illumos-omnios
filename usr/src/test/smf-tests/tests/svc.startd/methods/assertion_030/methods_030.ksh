...
#
# ASSERTION: methods_030
# DESCRIPTION:
#  The service possesses more than one process.
...
registration_template=$DATA/service_030.xml
...
print -- "--INFO: issue a hwerr via service pid $pid2"
