...
#
# ASSERTION: methods_001
# DESCRIPTION:
#  If an enabled service with no dependencies is registered with the
#  repository then it will be started up, and will reach the online
#  state. Becasue it is registered as an enabled service it will go
#  online without any user interaction once registered
#  The test is considered to have passed if the service reached the
#  online state.
#
