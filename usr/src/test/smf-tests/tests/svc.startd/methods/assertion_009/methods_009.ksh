...
#
# ASSERTION: methods_009
# DESCRIPTION:
#  A service is created who's start method returns the value 100.
#  It will transition to the maintenance mode immediately following
#  the execution of the start method once.
#
...
registration_template=$DATA/service_009.xml
...
manifest_generate $registration_template \
	...
	START_EVENT="returncode $SVC_METHOD_MAINTEXIT" \
	> $registration_file
...
if [ $? -ne 0 ]; then
	...
	print -- "  not transition to maintenance mode"
	exit $STF_FAIL
fi

print -- "--INFO: Validating single invocation of start method"
...
if [ $countstops -ne 1 ]; then
	...
	print -- "  start method too many times"
	exit $STF_FAIL
fi
