...
#  method being executed until the error threshold is reached and the
#  service not leaving the disabled state.
...
registration_template=$DATA/service_040.xml
...
manifest_generate $registration_template \
	...
	ENABLE_RESULT="returncode $SVC_METHOD_OTHEREXIT" \
	> $registration_file
