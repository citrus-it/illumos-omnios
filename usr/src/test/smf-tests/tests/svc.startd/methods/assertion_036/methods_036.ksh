...
#  method. The service has a single process.
...
registration_template=$DATA/service_036.xml
...
print -- "--INFO: setting core file generation for children"
...
print -- "--INFO: waiting for a core file to be generated"
file_wait_exist $RUNDIR/core.$PIDS
if [ $? -ne 0 ]; then
	print -- "--DIAG: $assertion: core file not generated"
	exit $STF_FAIL
fi
rm -f $RUNDIR/core.$PIDS
