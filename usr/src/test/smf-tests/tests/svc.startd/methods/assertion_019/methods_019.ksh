...
registration_template=$DATA/service_019.xml
...
print -- "--INFO: make the service stop... use dummy method"
...
service_dumpstate -s $test_service -i $test_instance
