...
registration_template=$DATA/service_028.xml
...
print -- "--INFO: cause one of the service processes to issue an hwerr"
$service_app -s $test_service -i $test_instance -l $service_log -m "trigger" \
	-r "forkexec 1 mtst udue"
