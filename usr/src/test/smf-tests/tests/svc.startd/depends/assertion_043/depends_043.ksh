...
#
# ASSERTION: depends_043
# DESCRIPTION:
#  A service with a dependency of optional_all will come online if
#  none of it's dependency services are enabled.
#  The service has a single dependency.
#
