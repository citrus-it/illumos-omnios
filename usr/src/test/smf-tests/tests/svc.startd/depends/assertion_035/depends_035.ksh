...
#
# ASSERTION: depends_035
# DESCRIPTION:
#  Dependencies can be added to an online service.
#
...
readonly registration_template=$DATA/service_035.xml
...
print -- "--INFO: Add dependency from $test_FMRI2 -> $test_FMRI1"
service_dependency_add $test_FMRI2 btoa require_all refresh svc:/$test_FMRI1
...
print -- "--INFO: Waiting for service $test_FMRI2 to go offline"
service_wait_state $test_FMRI2 offline
if [ $? -ne 0 ]; then
	print -- "--DIAG: service $test_FMRI2 didn't go offline"
	exit $STF_FAIL
fi
