...
readonly registration_template=$DATA/service_005.xml
...
print -- "--INFO: Checking if svc.startd is still executing"
pgrep -z $(zonename) svc.startd >/dev/null
if [ $? -ne 0 ]; then
