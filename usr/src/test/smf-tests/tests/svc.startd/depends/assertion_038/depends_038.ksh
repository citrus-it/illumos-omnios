...
# Why are you reading this? the assertion is invalid.
exit $STF_NOTINUSE
...
print -- "--INFO: Verify service $test_FMRI3 is offline"
service_wait_state $test_FMRI3 offline
if [ $? -ne 0 ]; then
	print -- "--DIAG: $assertion: Service $test_FMRI3 isn't offline"
	exit $STF_FAIL
fi
