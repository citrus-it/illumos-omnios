...
#
# Tests for the managed_paths manifest element. These cover import into
# a scratch repository, verification of the resulting properties, export
# back to manifest form, and rejection of invalid input.
#
...
#
# The exported manifest must be identical to what was imported.
#
