...
#
# a: Test removing file other read perms - expect OK
# b: Test restoring file other read perms - expect OK
# c: Test removing file other write perms - expect OK
# d: Test restoring file other write perms - expect OK
# e: Test removing file other execute perms - expect OK
# f: Test restoring file other execute perms - expect OK
# g: Test removing all other file perms - expect OK
# h: Test restoring all other file perms - expect OK
#
...
set tag "$TNAME{a}"
set ASSERTION "Test removing file other read perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set other_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_WRITE_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{b}"
set ASSERTION "Test restoring file other read perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

restore_perms $tfh OTHER FILE

# ------------------------------------------------------------------------
# c: Test removing file other write perms - expect OK

set tag "$TNAME{c}"
set ASSERTION "Test removing file other write perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set other_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_WRITE_ACL ] ]
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring file other write perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{e}"
set ASSERTION "Test removing file other execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set other_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_READ_ACL $POSIX_WRITE_ACL ] ]
...
set tag "$TNAME{f}"
set ASSERTION "Test restoring file other execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
# ------------------------------------------------------------------------
# g: Test removing all file other perms - expect OK

set tag "$TNAME{g}"
set ASSERTION "Test removing all file other perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
# ------------------------------------------------------------------------
# h: Test restoring all file other perms - expect OK

set tag "$TNAME{h}"
set ASSERTION "Test restoring all file other perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
