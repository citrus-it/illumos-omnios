...
#
# a: Test setting ACL type attr ACE4_SYSTEM_AUDIT_ACE_TYPE expect ATTRNOTSUPP 
# b: Test setting ACL type attr ACE4_SYSTEM_ALARM_ACE_TYPE expect ATTRNOTSUPP 
#
...
# Start testing
# ------------------------------------------------------------------------
#a: Test set ACL type attr ACE4_SYSTEM_AUDIT_ACE_TYPE ; expect ATTRNOTSUPP

set tag "$TNAME{a}"
set ASSERTION "Test set ACL type attr ACE4_SYSTEM_AUDIT_ACE_TYPE expect ATTRNOTSUPP"
putmsg stdout 0 "$tag: $ASSERTION"

set ACE4_SYSTEM_AUDIT_ACE_TYPE 2
set sid {0 0}
...
set new_owner [lreplace [split $owner] 0 0 "$ACE4_SYSTEM_AUDIT_ACE_TYPE"]
...
# ------------------------------------------------------------------------
#b: Test set ACL type attr ACE4_SYSTEM_ALARM_ACE_TYPE ; expect ATTRNOTSUPP

set tag "$TNAME{b}"
set ASSERTION "Test set ACL type attr ACE4_SYSTEM_ALARM_ACE_TYPE expect ATTRNOTSUPP"
putmsg stdout 0 "$tag: $ASSERTION"

set ACE4_SYSTEM_ALARM_ACE_TYPE 3
set sid {0 0}
...
#
set owner [lindex $acl_list 0]
set new_owner [lreplace [split $owner] 0 0 "$ACE4_SYSTEM_ALARM_ACE_TYPE"]
