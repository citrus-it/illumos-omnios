...
#
# a: Test removing dir owner read perms - expect OK
# b: Test restoring dir owner read perms - expect OK
# c: Test removing dir owner write perms - expect OK
# d: Test restoring dir owner write perms - expect OK
# e: Test removing dir owner execute perms - expect OK
# f: Test restoring dir owner execute perms - expect OK
...
set tag "$TNAME{a}"
set ASSERTION "Test removing dir owner read perms - expect OK"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set owner_allow_mask [ aclmask [ concat $OWNER_ALLOW_ACL $POSIX_WRITE_DIR_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{b}"
set ASSERTION "Test restoring dir owner read perms - expect OK"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{c}"
set ASSERTION "Test removing dir owner write perms - expect OK"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring dir owner write perms - expect OK"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{e}"
set ASSERTION "Test removing dir owner execute perms - expect OK"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{f}"
set ASSERTION "Test restoring dir owner execute perms - expect OK"
putmsg stdout 0 "$tag: $ASSERTION"
