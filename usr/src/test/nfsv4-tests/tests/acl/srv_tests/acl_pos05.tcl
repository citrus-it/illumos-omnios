...
#
# a: Test removing file other read/write perms - expect OK
# b: Test restoring file other read/write perms - expect OK
# c: Test removing file other read/execute perms - expect OK
# d: Test restoring file other read/execute perms - expect OK
# e: Test removing file other write/execute perms - expect OK
# f: Test restoring file other write/execute perms - expect OK
#
...
set tag "$TNAME{a}"
set ASSERTION "Test removing file other read/write perms  - expect $expcode"
...
set other_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_READ_ACL $POSIX_WRITE_ACL ] ]
...
set tag "$TNAME{c}"
set ASSERTION "Test removing file other read/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set other_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_WRITE_ACL ] ]

set other_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_READ_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring file other read/execute perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{e}"
set ASSERTION "Test removing file other write/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set other_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_WRITE_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{f}"
set ASSERTION "Test restoring file other write/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
