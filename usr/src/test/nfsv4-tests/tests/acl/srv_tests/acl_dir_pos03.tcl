...
#
# a: Test removing dir group read/write perms - expect OK
# b: Test restoring dir group read/write perms - expect OK
# c: Test removing dir group read/execute perms - expect OK
# d: Test restoring dir group read/execute perms - expect OK
# e: Test removing dir group write/execute perms - expect OK
# f: Test restoring dir group write/execute perms - expect OK
#
...
# Start testing
# ------------------------------------------------------------------------
# a: Test removing group read/write dir perms - expect OK

set tag "$TNAME{a}"
set ASSERTION "Test removing group read/write dir perms  - expect $expcode"
...
set group_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_READ_ACL $POSIX_WRITE_DIR_ACL ] ]
...
set tag "$TNAME{b}"
set ASSERTION "Test restoring dir group read/write perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{c}"
set ASSERTION "Test removing dir group read/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring dir group read/execute perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{e}"
set ASSERTION "Test removing dir group write/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set group_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_WRITE_DIR_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{f}"
set ASSERTION "Test restoring dir group write/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
