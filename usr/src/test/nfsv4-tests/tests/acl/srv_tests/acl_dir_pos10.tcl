...
#
# a: Test adding a default ACL of (rwxrwx-wx) to an existing directory
# b: Test the default ACL settings of (rwxrwx-wx) are inherited by sub-dir
# c: Test the default ACL settings of (rwxrwx-wx) are inherited by sub-file
# d: Test adding a default ACL of (rwxrwxr-x) to an existing directory
# e: Test the default ACL settings of (rwxrwxr-x) are inherited by sub-dir
# f: Test the default ACL settings of (rwxrwxr-x) are inherited by sub-file
# g: Test adding a default ACL of (rwxrwxrw-) to an existing directory
# h: Test the default ACL settings of (rwxrwxrw-) are inherited by sub-dir
# i: Test the default ACL settings of (rwxrwxrw-) are inherited by sub-file
...
if { $status == "OK" } {
	...
	if { [compare_acl_lists $new_acl_list $dir_acl_list MASK] != 0} {
        	putmsg stderr 0 \
                	"\t Test FAIL: setting default ACL failed."
	} 
}
...
set tag "$TNAME{a}"
set ASSERTION "Test adding a default ACL of (rwxrwx-wx) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Other - deny r, allow wx
...
set tag "$TNAME{b}"
set ASSERTION "Test the default ACL settings of (rwxrwx-wx) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{c}"
set ASSERTION "Test the default ACL settings of (rwxrwx-wx) are inherited by sub-file"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{d}"
set ASSERTION "Test adding a default ACL of (rwxrwxr-x) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Other - allow r/x, deny w
...
set tag "$TNAME{e}"
set ASSERTION "Test the default ACL settings of (rwxrwxr-x) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{f}"
set ASSERTION "Test the default ACL settings of (rwxrwxr-x) are inherited by sub-file"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{g}"
set ASSERTION "Test adding a default ACL of (rwxrwxrw-) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Other - allow rw, deny x
set other_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_READ_ACL \
$POSIX_WRITE_DIR_ACL ] ]
...
set tag "$TNAME{h}"
set ASSERTION "Test the default ACL settings of (rwxrwxrw-) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{i}"
set ASSERTION "Test the default ACL settings of (rwxrwxrw-) are inherited by sub-file"
putmsg stdout 0 "$tag: $ASSERTION"
