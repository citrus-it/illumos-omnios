...
#
# a: Test adding a default ACL of (rwx-wxrwx) to an existing directory
# b: Test the default ACL settings of (rwx-wxrwx) are inherited by sub-dir
# c: Test the default ACL settings of (rwx-wxrwx) are inherited by sub-file
# d: Test adding a default ACL of (rwxr-xrwx) to an existing directory
# e: Test the default ACL settings of (rwxr-xrwx) are inherited by sub-dir
# f: Test the default ACL settings of (rwxr-xrwx) are inherited by sub-file
# g: Test adding a default ACL of (rwxrw-rwx) to an existing directory
# h: Test the default ACL settings of (rwxrw-rwx) are inherited by sub-dir
# i: Test the default ACL settings of (rwxrw-rwx) are inherited by sub-file
...
if { $status == "OK" } {
	...
	if { [compare_acl_lists $new_acl_list $dir_acl_list MASK] != 0} {
        	putmsg stderr 0 \
                	"\t Test FAIL: default ACL setting incorrect"
		Disconnect
		exit $FAIL
...
set tag "$TNAME{a}"
set ASSERTION "Test adding a default ACL of (rwx-wxrwx) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Group - deny r, allow wx
...
# ------------------------------------------------------------------------
# b: Test the default ACL settings are inherited by sub-dir (rwx-wxrwx)

set tag "$TNAME{b}"
set ASSERTION "Test the default ACL settings of (rwx-wxrwx) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
# ------------------------------------------------------------------------
# c: Test the default ACL settings are inherited by sub-file (rwx-wxrwx)

set tag "$TNAME{c}"
set ASSERTION "Test the default ACL settings are inherited by sub-file (rwx-wxrwx)"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{d}"
set ASSERTION "Test adding a default ACL of (rwxr-xrwx) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Group - allow r/x, deny w
...
set tag "$TNAME{e}"
set ASSERTION "Test the default ACL settings of (rwxr-xrwx) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
# ------------------------------------------------------------------------
# f: Test the default ACL settings are inherited by sub-file (rwxr-xrwx)

set tag "$TNAME{f}"
set ASSERTION "Test the default ACL settings are inherited by sub-file (rwxr-xrwx)"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{g}"
set ASSERTION "Test adding a default ACL of (rwxrw-rwx) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Group - allow rw, deny x
set group_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_READ_ACL \
$POSIX_WRITE_DIR_ACL ] ]

set group_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{h}"
set ASSERTION "Test the default ACL settings of (rwxrw-rwx) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
# ------------------------------------------------------------------------
# i: Test the default ACL settings are inherited by sub-file (rwxrw-rwx)

set tag "$TNAME{i}"
set ASSERTION "Test the default ACL settings are inherited by sub-file (rwxrw-rwx)"
putmsg stdout 0 "$tag: $ASSERTION"
