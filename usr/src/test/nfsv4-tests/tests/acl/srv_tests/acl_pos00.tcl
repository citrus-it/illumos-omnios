...
#
# a: Test removing file owner read perms - expect OK
# b: Test restoring file owner read perms - expect OK
# c: Test removing file owner write perms - expect OK
# d: Test restoring file owner write perms - expect OK
# e: Test removing file owner execute perms - expect OK
# f: Test restoring file owner execute perms - expect OK
# g: Test removing all file owner perms - expect OK
# h: Test restoring all file owner perms - expect OK
#
...
set tag "$TNAME{a}"
set ASSERTION "Test removing file owner read perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set owner_allow_mask [aclmask [ concat $OWNER_ALLOW_ACL $POSIX_WRITE_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{b}"
set ASSERTION "Test restoring file owner read perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{c}"
set ASSERTION "Test removing file owner write perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set owner_allow_mask [ aclmask [ concat $OWNER_ALLOW_ACL $POSIX_READ_ACL $POSIX_EXECUTE_ACL ] ]

set owner_deny_mask [ aclmask $POSIX_WRITE_ACL ]
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring file owner write perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set owner_allow_mask [ aclmask [ concat $OWNER_ALLOW_ACL $POSIX_READ_ACL $POSIX_WRITE_ACL ] ]
...
set tag "$TNAME{g}"
set ASSERTION "Test removing all file owner perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set owner_deny_mask [ aclmask [ concat $POSIX_READ_ACL $POSIX_WRITE_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{h}"
set ASSERTION "Test restoring all file owner perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
