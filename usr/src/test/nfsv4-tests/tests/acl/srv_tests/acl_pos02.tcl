...
#
# a: Test removing file group read perms - expect OK
# b: Test restoring file group read perms - expect OK
# c: Test removing file group write perms - expect OK
# d: Test restoring file group write perms - expect OK
# e: Test removing file group execute perms - expect OK
# f: Test restoring file group execute perms - expect OK
# g: Test removing all file group perms - expect OK
# h: Test restoring all file group perms - expect OK
#
...
# Start testing
# ------------------------------------------------------------------------
# a: Test removing group read file perms - expect OK

set tag "$TNAME{a}"
set ASSERTION "Test removing group read file perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set group_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_WRITE_ACL $POSIX_EXECUTE_ACL ] ] 
...
set tag "$TNAME{b}"
set ASSERTION "Test restoring file group read perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

restore_perms $tfh GROUP FILE

# ------------------------------------------------------------------------
# c: Test removing file group write perms - expect OK

set tag "$TNAME{c}"
set ASSERTION "Test removing file group write perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set group_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_WRITE_ACL ] ]
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring file group write perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{e}"
set ASSERTION "Test removing file group execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set group_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_READ_ACL $POSIX_WRITE_ACL ] ]
...
set tag "$TNAME{f}"
set ASSERTION "Test restoring file group execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{g}"
set ASSERTION "Test removing all file group perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set group_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL ] ]

set group_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_READ_ACL $POSIX_WRITE_ACL \
$POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{h}"
set ASSERTION "Test restoring all file group perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
