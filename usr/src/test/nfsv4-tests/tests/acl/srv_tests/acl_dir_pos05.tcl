...
#
# a: Test removing dir other read/write perms - expect OK
# b: Test restoring dir other read/write perms - expect OK
# c: Test removing dir other read/execute perms - expect OK
# d: Test restoring dir other read/execute perms - expect OK
# e: Test removing dir other write/execute perms - expect OK
# f: Test restoring dir other write/execute perms - expect OK
#
...
set tag "$TNAME{a}"
set ASSERTION "Test removing dir other read/write perms  - expect $expcode"
...
set other_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_READ_ACL $POSIX_WRITE_DIR_ACL ] ]
...
set tag "$TNAME{b}"
set ASSERTION "Test restoring dir other read/write perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{c}"
set ASSERTION "Test removing dir other read/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring dir other read/execute perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{e}"
set ASSERTION "Test removing dir other write/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set other_deny_mask [ aclmask [ concat $GENERIC_DENY_ACL $POSIX_WRITE_DIR_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{f}"
set ASSERTION "Test restoring dir other write/execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
