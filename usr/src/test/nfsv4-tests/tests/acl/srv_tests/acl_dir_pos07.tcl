...
#
# a: Test adding a default ACL of (--xrwxrwx) to an existing directory
# b: Test the default ACL settings of (--xrwxrwx) are inherited by sub-dir
# c: Test the default ACL settings of (--xrwxrwx) are inherited by sub-file
# d: Test adding a default ACL of (-w-rwxrwx) to an existing directory
# e: Test the default ACL settings of (-w-rwxrwx) are inherited by sub-dir
# f: Test the default ACL settings of (-w-rwxrwx) are inherited by sub-file
# g: Test adding a default ACL of (r--rwxrwx) to an existing directory
# h: Test the default ACL settings of (r--rwxrwx) are inherited by sub-dir
# i: Test the default ACL settings of (r--rwxrwx) are inherited by sub-file
...
if { $status == "OK" } {
	...
	putmsg stderr 1 "$TNAME: re-read ACL : $new_acl_list"
...
set tag "$TNAME{a}"
set ASSERTION "Test adding a default ACL of (--xrwxrwx) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Owner - deny rw, allow x
...
if { $status == "OK" } {
	...
	if { [compare_acl_lists $new_acl_list $new_dir_acl MASK] != 0} {
        	putmsg stderr 0 \
...
set tag "$TNAME{b}"
set ASSERTION "Test the default ACL settings of (--xrwxrwx) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
if {$sdfh == $NULL} {
	...
	if $IsZFS {
                set exp_acl [ concat $inherited_acl_dir_owner_list_b       \
...
set tag "$TNAME{c}"
set ASSERTION "Test the default ACL settings of (--xrwxrwx) are inherited by sub-file"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{d}"
set ASSERTION "Test adding a default ACL of (-w-rwxrwx) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Owner - allow write, deny r/x
...
# ------------------------------------------------------------------------
# e: Test the default ACL settings are inherited by sub-dir (-w-rwxrwx)

set tag "$TNAME{e}"
set ASSERTION "Test the default ACL settings of (-w-rwxrwx) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{f}"
set ASSERTION "Test the default ACL settings of (-w-rwxrwx) are inherited by sub-file"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{g}"
set ASSERTION "Test adding a default ACL of (r--rwxrwx) to an existing directory"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

# Owner - allow read, deny wx
...
set tag "$TNAME{h}"
set ASSERTION "Test the default ACL settings of (r--rwxrwx) are inherited by sub-dir"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{i}"
set ASSERTION "Test the default ACL settings of (r--rwxrwx) are inherited by sub-file"
putmsg stdout 0 "$tag: $ASSERTION"
