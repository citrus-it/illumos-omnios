...
#
# a: Test removing dir group read perms - expect OK
# b: Test restoring dir group read perms - expect OK
# c: Test removing dir group write perms - expect OK
# d: Test restoring dir group write perms - expect OK
# e: Test removing dir group execute perms - expect OK
# f: Test restoring dir group execute perms - expect OK
# g: Test removing all dir group perms - expect OK
# h: Test restoring all dir group perms - expect OK
#
...
set dirname "newdirA.[pid]"
set dpath  [file join ${BASEDIR} ${dirname}]

# Create the test directory with all perms set (-rwxrwxrwx) and get its handle.
...
# Start testing
# ------------------------------------------------------------------------
# a: Test removing group read dir perms - expect OK

set tag "$TNAME{a}"
set ASSERTION "Test removing group read dir perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set group_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_WRITE_DIR_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{b}"
set ASSERTION "Test restoring dir group read perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

restore_perms $dfh GROUP DIR

# ------------------------------------------------------------------------
# c: Test removing dir group write perms - expect OK

set tag "$TNAME{c}"
set ASSERTION "Test removing dir group write perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set group_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_READ_ACL $POSIX_EXECUTE_ACL ] ]
...
set tag "$TNAME{d}"
set ASSERTION "Test restoring dir group write perms  - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{e}"
set ASSERTION "Test removing dir group execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set group_allow_mask [ aclmask [ concat $GENERIC_ALLOW_ACL $POSIX_READ_ACL $POSIX_WRITE_DIR_ACL ] ]
...
set tag "$TNAME{f}"
set ASSERTION "Test restoring dir group execute perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
...
set tag "$TNAME{g}"
set ASSERTION "Test removing all dir group perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"

set sid {0 0}

set group_allow_mask [ aclmask $GENERIC_ALLOW_ACL ]
...
set tag "$TNAME{h}"
set ASSERTION "Test restoring all dir group perms - expect $expcode"
putmsg stdout 0 "$tag: $ASSERTION"
