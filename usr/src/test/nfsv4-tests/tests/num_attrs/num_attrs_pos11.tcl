...
#
# {a}:Test get attr FATTR4_CANSETTIME of a filesystem object, expect OK
#
...
# Start testing 
# -----------------------------------------------------------------
# a:Test get attr FATTR4_CANSETTIME of a file object, expect OK

set ASSERTION "Test get attr FATTR4_CANSETTIME of a filesystem, expect $expcode"
putmsg stdout 0 "$TNAME{a}: $ASSERTION"

set expval $env(CANSETTIME)
...
set attrval [ extract_attr [lindex [lindex $res 3] 2] "cansettime" ]
