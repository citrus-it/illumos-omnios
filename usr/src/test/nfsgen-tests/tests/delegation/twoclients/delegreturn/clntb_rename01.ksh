...
echo "client a opens a file RDONLY, get read delegation"
echo "client b renames it, client a returns delegation"
...
LOCAL_CMD="cd $MNTDIR && chgusr_exec $DTESTUSER1 $local_prog -R -c -d -o 0 \
	-B \\\"1 1 -1\\\" testfile.$$"
DTYPE=$RD
REMOTE_CMD="mv $CLNT2_TESTDIR/testfile.$$ $CLNT2_TESTDIR/testfile.$$.tmp" 
