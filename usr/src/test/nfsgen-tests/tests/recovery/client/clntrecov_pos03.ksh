...
# a: Verify client recovers on open and write ops after server re-boots; \
# recovery verified by read op, expect OK
# b: Verify client recovers on open and write ops after nfsd dies and \
# and restarts; recovery verified by read op, expect OK
#
...
# ----------------------------------------------------------------------
ASSERTION_a="Verify client recovers on open and write after \
	server reboots; recovery verified by read op, expect sucess"
ASSERTION_b="Verify client recovers on open and write ops after nfsd \
	dies and re-starts; recovery verified by read op, expect sucess"
